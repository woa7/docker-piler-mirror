...
struct _parse_rule config_parse_rules[] =
{
   ...
   { "s3_access_key", "string", (void*) string_parser, offsetof(struct config, s3_access_key), "", MAXVAL-1},
   { "s3_host", "string", (void*) string_parser, offsetof(struct config, s3_host), "", MAXVAL-1},
   { "s3_key", "string", (void*) string_parser, offsetof(struct config, s3_key), "", MAXVAL-1},
   { "s3_secret_key", "string", (void*) string_parser, offsetof(struct config, s3_secret_key), "", MAXVAL-1},
